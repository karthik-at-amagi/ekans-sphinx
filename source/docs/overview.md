...
```{admonition} Heads up
This is a placeholder page that shows you how this Sphinx + MyST site hangs
together.
```
...
put your overview contents directly on the documentation landing page (similar
to how Sphinx’s own docs open with their highlights).
